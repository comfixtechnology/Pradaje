...
namespace Pradadge.Service.CoreApi.Controllers
{
    ...
    public class StateController : ApiController
    {
        ...
        public StateController (IStatesRepository staterepository)
        {
        ...
        [HttpPost]
        [Route("createstate")]
        public HttpResponseMessage AddState([FromBody] StateViewModel model)
        {
            try
            {
                var data = staterepository.AddState(model);
                if (data != null)
                {
        ...
        public HttpResponseMessage GetState()
        {
            try
            {
                var data = staterepository.GetAllStates();
        ...
        public HttpResponseMessage GetStateById(int id)
        {
            try
            {
                var data = staterepository.GetStateById(id).ToList();
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data });
            }
            catch (Exception e)
            {
        ...
        [HttpPut]
        [Route("updatestate")]
        public HttpResponseMessage UpdateState([FromBody] StateViewModel model)
        {
            try
            {
                var data = staterepository.UpdateState(model);
                if (data != null)
                {
